...
const STEPS = [
  ...
  },
  {
    ...
    title: "AI Research & Drafting",
    description:
      "Our AI pipeline researches applicable laws and statutes for your jurisdiction, then drafts a professional legal letter tailored to your specific situation.",
  },
  {
    icon: ShieldCheck,
    ...
    description:
      "A licensed attorney reviews the AI draft, makes any necessary edits, and approves the final letter. No letter is delivered without attorney sign-off.",
  },
  {
    icon: Download,
